...
public class Quiz2 {
	...
	public static void main(String[] args) {
		 ...
		 Scanner sc = new Scanner(System.in);
	        ...
	        ArrayList name = new ArrayList();	   						// 이름을 저장할 ArrayList name 생성
	        
	        ArrayList num = new ArrayList();							// 번호를 저장할 ArrayList num 생성
	        
	        String na, nu;											    // 이름, 번호를 입력받을 변수 선언
	        
	        boolean bool = true;										// 종료했을때 while문을 탈출할 변수 선언
	        
	       
	        while(bool) {												 // 연락처 프로그램 반복실행
	            ...
	            case 1:
	                ...
	                if(name.indexOf(na) == -1) {									// indexof  해당하는값의 위치를(index) 가져온다.
	                    name.add(na);
